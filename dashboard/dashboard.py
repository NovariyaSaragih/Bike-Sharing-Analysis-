...
# Pertanyaan 2: Visualisasi pola ketersediaan sepeda berdasarkan jam, hari, dan musim
@st.cache
...
# Pertanyaan 3: Visualisasi perbedaan penggunaan sepeda antara hari kerja dan akhir pekan dengan interval kepercayaan
@st.cache
...
st.header('Pertanyaan 1: Statistik Jumlah Peminjaman Sepeda pada Hari Kerja dan Hari Libur')
visualize_rentals_difference()

st.header('Pertanyaan 2: Pola Ketersediaan Sepeda Berdasarkan Jam, Hari, dan Musim')
visualize_bike_availability_pattern()

st.header('Pertanyaan 3: Perbedaan Penggunaan Sepeda antara di Hari Kerja dan di Akhir Pekan')
